...
def section_members():
    ...
    with st.form("member_form", clear_on_submit=False):
        ...
        id_until  = id2.date_input("Osobna vrijedi do", value=date.today(), key="id_card_valid_until_v5_1")
        id_issuer = id3.text_input("Izdavatelj")

        st.markdown("**Putovnica**")
        p1, p2, p3 = st.columns(3)
        pass_no     = p1.text_input("Broj putovnice")
        pass_until  = p2.date_input("Putovnica vrijedi do", value=date.today(), key="passport_valid_until_v5_1")
